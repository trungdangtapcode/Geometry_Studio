...
- Toggle Graph in the timeline and confirm a keyed Position / Rotation / Scale track draws value curves while scrubbing. Drag a graph key point horizontally and vertically to retime a key and edit a channel value, hold Shift to constrain the drag, then Undo to restore it.
