...
- Collapse and expand object, camera, and light timeline layer groups, Alt-click a group to collapse or expand all groups, then use row search to reveal a hidden property row.
