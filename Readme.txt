...
- Add Position / Rotation / Scale keyframes in the bottom timeline using either the Set Key / Update Key button or a row diamond key button, copy/paste a keyframe, scrub the playhead, and verify motion plays.
