...
test("fits selected keyframe timing so the last key lands on the playhead", async ({ page }) => {
  ...
  await setTimelineTime(page, 6);
  await page.locator("#timeline-fit-playhead-keyframes").click();
