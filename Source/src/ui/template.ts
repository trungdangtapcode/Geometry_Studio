        ...
        <section class="keyframe-dock" id="keyframe-dock" aria-label="Keyframe timeline">
          ...
          <header class="timeline-header">
            ...
            <div class="timeline-toolbar" id="timeline-toolbar" tabindex="0" aria-label="Scrollable timeline command toolbar">
              ...
              <button class="mini-button" id="timeline-duplicate-layer" type="button" title="Duplicate selected layer with its animation tracks (Ctrl+Alt+D)"><span data-icon="Copy"></span><span>Layer Dup</span></button>
              ...
              <button class="mini-button" id="timeline-paste-reverse-keyframes" type="button" disabled title="Copy keyframes before reverse-pasting"><span data-icon="ArrowLeftRight"></span><span>Paste Rev</span></button>
              <button class="mini-button" id="timeline-paste-reverse-insert-keyframes" type="button" disabled title="Copy keyframes before reverse insert-pasting"><span data-icon="ListPlus"></span><span>Rev Insert</span></button>
              ...
              <button class="mini-button" id="timeline-exponential-scale" type="button" title="Convert selected Scale keys into exponential frame keys"><span data-icon="TrendingUp"></span><span>Expo Scale</span></button>
              ...
              <button class="mini-button" id="timeline-ping-pong-keyframes" type="button" title="Repeat selected keyframes forward then backward until Work Out"><span data-icon="Repeat"></span><span>Ping-Pong</span></button>
              <button class="mini-button" id="timeline-offset-loop-keyframes" type="button" title="Repeat selected keyframes while accumulating end-minus-start values"><span data-icon="TrendingUp"></span><span>Offset</span></button>
              <button class="mini-button" id="timeline-hold-keyframes" type="button" title="Freeze selected key values at Work Out and set their source keys to Hold"><span data-icon="Pause"></span><span>Freeze</span></button>
          ...
          <div class="timeline-keyframe-editor" id="timeline-keyframe-editor">
            ...
            <label><span>In %</span><input id="timeline-key-ease-in" type="number" min="0" max="200" step="5" disabled /></label>
            <label><span>Out %</span><input id="timeline-key-ease-out" type="number" min="0" max="200" step="5" disabled /></label>
