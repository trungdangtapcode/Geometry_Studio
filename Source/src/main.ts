...
function boot(root: HTMLDivElement): void {
  ...
  const timelinePanel = new KeyframeTimelinePanel({
    ...
    onPingPongKeyframesAcrossWorkArea: pingPongTimelineKeyframesAcrossWorkArea,
    onOffsetLoopKeyframesAcrossWorkArea: offsetLoopTimelineKeyframesAcrossWorkArea,
  ...
  function shortcutTooltipBindings(): ShortcutTooltipBinding[] {
    return [
      ...
      { selector: "#timeline-ping-pong-keyframes", commandId: "timeline.ping-pong-keys" },
      { selector: "#timeline-offset-loop-keyframes", commandId: "timeline.offset-loop-keys" },
