...
previous/next frame buttons and keyboard shortcuts. The editor stores rotation
keyframes in readable Euler degrees and converts transform animation to Three.js
playback tracks where appropriate.
