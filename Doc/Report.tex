...
The keyframe timeline provides a bottom editing dock with a playhead, duration,
FPS, snapping, loop control, and Position / Rotation / Scale tracks. Users can
add, delete, drag, scrub, save, and reload transform keyframes. The editor stores
rotation keyframes in readable Euler degrees and converts them to
\texttt{QuaternionKeyframeTrack} objects for Three.js playback.
