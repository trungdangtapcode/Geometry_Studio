...
manageable while preserving access to the active track. Frame-accurate
navigation is available through previous/next frame buttons and keyboard
shortcuts, while selected keyframes can be nudged one frame left or right for
precise retiming. A compact keyframe editor allows precise numeric edits to
keyframe time and vector or scalar values. The editor stores rotation keyframes
in readable Euler degrees and converts transform animation to Three.js playback
