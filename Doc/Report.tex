...
manageable while preserving access to the active track. Named timeline markers
add cue points for animation beats, camera moves, and demo sections.
...
edits to keyframe time and vector or scalar values. The editor stores rotation
