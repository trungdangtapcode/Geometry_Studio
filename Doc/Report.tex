...
\title{\textbf{CS105 Geometry Studio}\\Computer Graphics 3D Project Report}
...
\begin{abstract}
CS105 Geometry Studio is an interactive WebGL2 application for demonstrating core
...
The application is built with Three.js, TypeScript, and Vite, and is packaged as
a static release that can be served locally for grading.
\end{abstract}
...
The timeline supports play and pause. Per-object animation modes include:
\begin{itemize}
  \item Spin
  \item Orbit
  \item Bounce
...
changes, camera changes, and lighting changes.
...
To run from source:
\begin{verbatim}
cd CS105_Geometry_Studio/Source
npm install
npm run dev
\end{verbatim}
...
\begin{verbatim}
cd CS105_Geometry_Studio/Release
...
CS105 Geometry Studio satisfies the project requirements for 3D geometry,
