...
manageable while preserving access to the active track. Each timeline row also
...
keyframes in readable Euler degrees and compiles rotation playback to per-axis
Euler channels, preserving authored full turns such as \(0^\circ\) to
\(360^\circ\).
...
\begin{itemize}
  ...
  \item Rotation uses per-axis \texttt{NumberKeyframeTrack} channels targeting
