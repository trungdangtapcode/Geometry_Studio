...
delete, duplicate, drag, scrub, save, and reload keyframes. Frame-accurate
navigation is available through previous/next frame buttons and keyboard
shortcuts. The editor stores rotation keyframes in readable Euler degrees and
converts transform animation to Three.js playback tracks where appropriate.
