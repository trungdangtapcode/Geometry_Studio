...
current schema v7. They extend the existing dope-sheet rather than adding a
...
uses version 7 after object appearance, material, and texture property tracks
were added:
...
6. Save JSON and verify `timeline.version` is `7` and
