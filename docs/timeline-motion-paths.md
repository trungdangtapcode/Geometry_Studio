...
- `createMotionPathRig()` creates a persistent group containing a line and key
  point cloud.
...
5. The helper samples keyframes and replaces the line/point geometries.
...
- Path labels showing keyframe times.
